...
public class ImprovedOrientationSensorProvider extends OrientationProvider {
    private final static String TAG = "Rotation Vector";
    ...
    /**
     * Initialises a new ImprovedOrientationSensorProvider
     *
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            case Sensor.TYPE_ROTATION_VECTOR:
                ...
                /* Save to quaternion */
                quaternionRotationVector.setXYZW(
                        temporaryQuaternion[1],
                        temporaryQuaternion[2],
                        temporaryQuaternion[3],
                        temporaryQuaternion[0] * -1);
            ...
            case Sensor.TYPE_GYROSCOPE:
                ...
                if (timestamp != 0) {
                    ...
                    /*
                     * Convert axis-angle representation of the delta rotation
