package com.yust.ariel.a6over6.data;
...
public class Quaternion extends Vector4f {
    ...
    public Quaternion(Quaternion clone) {
        ...
        matrix = new MatrixF4x4(clone.getMatrix4x4());
        points = new float[4];
        System.arraycopy(clone.points, 0, points, 0, points.length);
    }
    ...
    public float getYawDegree() {
        return (float) (180 * getYaw() / Math.PI);
    }

    public float getPitchDegree() {
        return (float) (180 * getPitch() / Math.PI);
    }

    public float getRollDegree() {
        return (float) (180 * getRoll() / Math.PI);
    }
